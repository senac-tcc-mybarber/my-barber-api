...
public class DataInitialization {
        ...
        InitializingBean carregaDados() {
                return () -> {
                        ...
                        final Set<Servico> setServico1 = new HashSet<Servico>();
                        setServico1.add(s1);
                        setServico1.add(s2);
                        p1.setServicos(setServico1);
                        final Set<Salao> setSalao1 = new HashSet<Salao>();
                        setSalao1.add(sa1);
                        setSalao1.add(sa2);
                        ...
                        final Set<Servico> setServico2 = new HashSet<Servico>();
                        setServico2.add(s3);
                        setServico2.add(s4);
                        p2.setServicos(setServico2);
                        final Set<Salao> setSalao2 = new HashSet<Salao>();
                        setSalao2.add(sa2);
                        setSalao2.add(sa3);
                        ...
                        final Set<Servico> setServico3 = new HashSet<Servico>();
                        setServico3.add(s5);
                        setServico3.add(s1);
                        p3.setServicos(setServico3);
                        final Set<Salao> setSalao3 = new HashSet<Salao>();
                        setSalao3.add(sa3);
                        setSalao3.add(sa4);
                        ...
                        final Set<Servico> setServico4 = new HashSet<Servico>();
                        setServico4.add(s4);
                        setServico4.add(s2);
                        p4.setServicos(setServico4);
                        final Set<Salao> setSalao4 = new HashSet<Salao>();
                        setSalao4.add(sa4);
                        setSalao4.add(sa1);
